...
namespace gacha.Controllers
{
    public class permissionsController : Controller
    {
        ...
        public permissionsController(gachaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,permissionDesc")] permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,permissionDesc")] permission permission)
        {
            if (id != permission.id)
            {
                return NotFound();
